              ...
              {
                {
                  ...
                  {
                    BinaryPrimitives.WriteInt32LittleEndian(memory.Span.Slice(_i197 * sizeof(int)), offset);
                  ...
                  BinaryPrimitives.WriteInt32LittleEndian(memory.Span.Slice(length * sizeof(int)), offset);
